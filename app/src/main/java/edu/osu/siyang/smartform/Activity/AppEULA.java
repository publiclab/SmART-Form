...
/**
 * Created by siyangzhang on 4/6/17.
 */
...
public class AppEULA {
    ...
    public void show() {
        ...
        if (bAlreadyAccepted == false) {
            ...
            // EULA title
            String title = mContext.getString(edu.osu.siyang.smartform.R.string.app_name) + "v"
            + versionInfo.versionName;

            // EULA text
            String message = mContext.getString(edu.osu.siyang.smartform.R.string.eula);
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext)
                    ...
                    .setMessage(message)
                    .setCancelable(false)
                    .setPositiveButton(edu.osu.siyang.smartform.R.string.agree,
                    ...
                    .setNegativeButton(edu.osu.siyang.smartform.R.string.disagree,
                            new Dialog.OnClickListener() {
