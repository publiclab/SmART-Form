...
public class IntroActivity extends AppIntro2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("First Intro", "List View", R.drawable.app_intro1, R.color.colorBtnPressed));
        addSlide(AppIntroFragment.newInstance("Second Intro", "New Test", R.drawable.app_intro2, R.color.colorBtnPressed));
