...
public class DatePickerFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View v = getActivity().getLayoutInflater().inflate(edu.osu.siyang.smartform.R.layout.dialog_date, null);
		
		DatePicker datePicker = (DatePicker)v.findViewById(edu.osu.siyang.smartform.R.id.dialog_date_picker);
		...
		return new AlertDialog.Builder(getActivity())
			.setView(v)
			.setTitle(edu.osu.siyang.smartform.R.string.date_picker_title)
			.setPositiveButton(
					android.R.string.ok, 
